...
namespace Animals
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            new Tomcat(15, "Мац", "femail", "miau"),
            new Tomcat(11, "Мацr", "femail", "miau miau"),
            new Tomcat(1, "Saa", "femail", "bau miau"),
            
        };

            Cat[] cats = new Cat[]
        {
            new PussyCat(1, "Saa", Female, "bau miau"),
                        new Tomcat(2, "Bab", "male", "bau miau"),
